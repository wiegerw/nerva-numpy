...
import unittest
from nerva_numpy.loss_functions import SoftmaxCrossEntropyLossFunction, LossFunction, SquaredErrorLossFunction, \
    NegativeLogLikelihoodLossFunction, CrossEntropyLossFunction, LogisticCrossEntropyLossFunction
from nerva_numpy.loss_functions import Squared_error_loss, Softmax_cross_entropy_loss
