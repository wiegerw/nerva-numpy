...
rm -f "${OUTPUT_DIRECTORY}/nerva-numpy.html"
...
asciidoctor "${COMMON_OPTS[@]}" -a "bibtex-file=../latex/nerva.bib" nerva-numpy.adoc
echo "Generated: ${OUTPUT_DIRECTORY}/nerva-numpy.html"
popd >/dev/null
